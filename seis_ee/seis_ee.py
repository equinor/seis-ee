...
@click.option("--file-detection", type=click.Choice(Config.NEW_FILE_DETECTION, case_sensitive=False), help="Use either inotify or regular python code for detecting new files")
