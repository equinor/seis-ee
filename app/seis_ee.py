...
@click.option("--format", type=click.Choice(Settings.REDUCE_FILES_OPTIONS, case_sensitive=False),
              help=f"Format of the files to reduce. One of {Settings.REDUCE_FILES_OPTIONS}")
@click.option("--file-detection", type=click.Choice(Settings.NEW_FILE_DETECTION, case_sensitive=False), help="Use either inotify or regular python code for detecting new files")
