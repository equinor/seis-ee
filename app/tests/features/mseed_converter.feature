...
Feature: Convert decimated files to mseed format
  ...
  Scenario: Message is added to convert queue with Grane file info
    ...
    Then after converting a "grane" file, "tempfile.sgy.mseed" has been created in "data/mseed"
  ...
  Scenario: Message is added to convert queue with Snorre file info
    ...
    Then after converting a "snorre" file, "tempfile.sgy.mseed" has been created in "data/mseed"
  ...
  Scenario: Message is added to convert queue with Oseberg file info
    ...
    Then after converting a "oseberg" file, "tempfile.sgy.mseed" has been created in "data/mseed"