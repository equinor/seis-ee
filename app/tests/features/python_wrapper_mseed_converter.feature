...
Feature: set up python wrapper for mseed converter
  set up python wrapper for mseed converter

  Scenario: run mseed converter from python
    Given an empty convert-queue
    And there are GRANE files in the blob storage
